    ...
    >
      <main className={styles.main}>
        ...
        <ol>
          ...
          <li><span >tentar descompilar ou fazer engenharia reversa de qualquer software contido no site When CAC;&nbsp;</span></li>
        ...
        <ol>
          <li>
            <span >
              Os materiais no site da When CAC são fornecidos 'como estão'. When CAC não oferece garantias, expressas ou implícitas, e, por este meio, isenta e nega todas as outras garantias, incluindo, sem limitação, garantias implícitas ou
              condições de comercialização, adequação a um fim específico ou não violação de propriedade intelectual ou outra violação de direitos.
            </span>
          </li>
          <li>
            <span >
